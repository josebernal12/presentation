...
const Modal = () => {
  ...
  return (
    <>
      <Button onClick={() => setModal(!modal)} type="button" variant="secondary">
      ...
      {modal && (
        <div
          ...
          tabIndex={-1}
          aria-hidden="true"
          className="bg-gray-500 bg-opacity-50 flex items-center justify-center overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full h-screen"
        >
