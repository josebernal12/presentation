...
const Roles = () => {
    return (
        <section className="container mx-auto p-20">
            <h3 className="text-center text-2xl text-indigo-700">El Sistema Cuenta con 2 Roles: Modo Admin y Modo Miembro</h3>
            <div className="grid md:grid-cols-2 py-5 gap-3">
                <button onClick={() => window.location.href = '#modo-administrador'} className="bg-indigo-700 p-3 rounded-md">
                ...
                <button onClick={() => window.location.href = '#modo-miembro'} className="bg-indigo-700 p-3 rounded-md">
